...
Note: You have to download [Tesseract](https://github.com/UB-Mannheim/tesseract/wiki) to run this program. If program doesn't run try specifying the Tesseract path in autotyper.py line 40 so that it corresponds with your own.
